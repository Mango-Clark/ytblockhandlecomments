# 📚 YouTube Comment Blocker 위키 — v0.6.0
...
`v0.6.0` 이후에는 큰 관리자/보안/i18n/regex-selection 성능/Shorts 댓글 숨김/긴 세션
메모리 정리/pair update 최소화/버전 표시/source split/관리자 polish TODO가
