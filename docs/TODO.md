...
- API Fetching delay 동안 UX 위해서 loading bar 추가
- 설정 <-> 차단 목록 오갈 수 있는 버튼 추가
- 글자 크기 조절 옵션을 설정에 추가. (지금 크기는 5단계중 2단계. 기본값 3단계)
- UI가 화면을 차지하는 비율을 설정할 수 있게 해줘. 지금 값은 5단계중 2단계로 설정.(기본값 3단계)
