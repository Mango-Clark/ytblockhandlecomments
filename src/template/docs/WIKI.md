...
- `12-block-list-manager.ts` is the stable public entry point. `12a`–`12d` own list state, settings/API lifecycle, import/export data and persistence helpers, and pair-result presentation; `12e-manager-runtime.ts` composes the remaining manager UI.
