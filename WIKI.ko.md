# 📚 YouTube Comment Blocker 위키 — v0.5.0

[English](WIKI.md) | [한국어](WIKI.ko.md)

이 문서는 `README.md`보다 현재 구현을 더 자세히 설명합니다.
...
`v0.5.0` 이후에는 큰 관리자/보안/i18n/regex-selection 성능/Shorts 댓글 숨김/긴 세션
메모리 정리/pair update 최소화/버전 표시 TODO가 기본적으로 마무리된 상태로 봅니다.
